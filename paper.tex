...
In our case, the ANNO-core, shown in \cref{fig:core}, functions as a TO, see \cref{sec:core}.
...
The subclasses of the ANNO-Core classes build a DO, the ANNO-domain, see \cref{sec:domain}.
