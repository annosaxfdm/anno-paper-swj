...
%\newcommand{\revision}[1]{\textcolor{red}{#1}}% for seeing changes in red
\newcommand{\revision}[1]{#1}% for final output
...
\begin{review}{editor}
\reviewer{\fnms{Guilin} \snm{Qi}\address{\orgname{University of Karlsruhe}, \cny{Germany}}}
...
\reviewer{\snm{anonymous reviewer}}
\reviewer{\fnms{Yuming} \snm{Shen}\address{\orgname{University of Oxford}, \cny{United Kingdom}}}
\end{review}
