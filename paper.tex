...
% An anderer Stelle haben wir für viel größere Textmengen keine subsection und hier für ganz wenig Text eine, ist das OK so?
...
%
%\textbf{UNFINISHED DRAFT SECTION, TO BE HEAVILY REWORKED AND CUT} <-- is this still todo?
...
\todo{is this still an unfinished draft section?}
...
%\todo{KH: was sollen wir damit machen? eins von beiden raussuchen oder beide stehen lassen oder nur als Reviewerkommentar?} habe jetzt einen Teil entfernt
\aw{} is not publicly accessible, as this could affect the consent and rights of the partners involved in its development.
%\aw{} has not yet been published.
%It was developed as part of another project.
%Publication of the software is planned as part of the project.
