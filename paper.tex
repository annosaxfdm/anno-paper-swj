...
the category \enquote{Phenotype} to model the rules for determining human phenotypes. The ANNO-core is founded by \emph{General Formal Ontology} (GFO)~\citep{gfo}.
...
The \aw{} uses the ANNO-core as an interface to access the ANNO-domain entities, e.g. by listing all subclasses of a specific ANNO-core class, such as \aurl{anno}{Bone}, as described in \cref{sec:aw}.
