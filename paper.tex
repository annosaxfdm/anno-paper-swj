...
\aurl{gfo}{Material_object}, \aurl{gfo}{Attributive}, \aurl{gfo}{Relator} as well as the spatial entities of GFO, \aurl{gfo}{Line_region} and \aurl{gfo}{Surface_region} (\cref{sec:core}, \cref{fig:gfo}).
\end{enumerate}
