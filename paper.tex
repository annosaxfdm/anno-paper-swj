...
On the one hand, these are controlled vocabularies, but on the other hand, ontologies are also conceptualizations that the vocabulary terms are intended to capture.
%TODO: find the correct reference and attach to the sentence above. this one gives a server error.
%[https://citeseerx.ist.psu.edu/document?repid=rep1&type=pdf&doi=2594b664bcba99205effbd2e53d18fbb8c154937].
