...
Currently prevalent issues of access could be solved as examinations can be conducted even if the skeletal material from individuals or collectives are not present at the institution or may have already been reburied.
...
Data sets consolidated this way and adequately formalised would enable the application of efficient data analysing methods such as data mining and textmining techniques that could promote more in-depth insights.
Representing the anthropological domain through an ontology, such as the Anthropological Notation Ontology (ANNO) proposed here,  is an suitable form of formalisation (QUELLE 4).
...
By transferring the principle of Earth topography, it is possible to create a precise map of the human skeletal and musculoskeletal system’s „terrain“ (QUELLE 6).
