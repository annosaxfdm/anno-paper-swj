...
\newcommand{\gfo}[1]{\href{https://annosaxfdm.de/ontology/#1}{\texttt{#1}}}
\newcommand{\fma}[1]{\href{http://purl.org/sig/ont/fma/fma#1}{\texttt{#1}}}
\daurl{anno}{https://annosaxfdm.de/ontology/}
\daurl{gfo}{https://annosaxfdm.de/ontology/}%todo: insert gfo prefix
...
\begin{table}[htbp]
  ...
  \begin{tabulary}{\textwidth}{lLLl}
	...
	\anno{SpatialAnatomical entity}	&						&immaterial anatomical entity fma:\fma{67112}	&\gfo{SpaceEntity}\\
