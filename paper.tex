...
Digitization offers several advantages to anthropology, including remote work, without the effects of wear and tear on the physical skeletal specimens.
...
ANNO is integrated into AnthroWorks3D (AW3D), an application for generating and analyzing 3D-models of human skeletal remains.
...
\begin{enumerate}
\item We use the General Formal Ontology (GO)~\citep{gfo} as top-level ontology of ANNO.
...
An anatomical direction or relative anatomical location, as shown in \cref{fig:relativelocation}, is the position of an anatomical entity (e.g., a bone structure) in relation to another anatomical entity (e.g., another bone, an axis, a plane or a point such as the center of the body).
...
For the definitions and measurements, a minimum amount of English- and mostly German-language literature was compared in order to develop the definitions from their information.
Notably, Latin or ancient Greek terms were missing from the English literature and the FMA.
%The FMA also contains only English terms.
%For this reason, these were also searched with their synonyms.
Overall, the name of the landmark or survey route is noted in English, German, and Latin in singular and plural form, its synonyms in the three languages, the FMA and TA ID, and any information on function and delineation.
...
The functions are divided into discriminant functions for sex determination and regress functions for body height and body weight estimation.
...
By contributing systematic, standardized and clear definitions for (material and spatial) anatomical entities regarding the human skeleton as well as anthropological aspects such as the derivation of phenotypes, ANNO provides formalized knowledge of the anatomical and anthropology domain.
...
Furthermore, it offers a procedure for conceptualizing the ontology and generating its content.
