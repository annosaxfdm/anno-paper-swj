...
\anno{BoneCompound}: subclass of (\aurl{gfo}{hasPart} some (\anno{Bone} or \anno{BoneCompound} or \anno{BonePart}))
...
\anno{Phenotype}: subclass of (\aurl{gfo}{derivedFrom} some (\anno{AnatomicalEntity} or \anno{AnatomicalProperty}))
