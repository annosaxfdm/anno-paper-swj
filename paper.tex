...
\todo{Marie: bitte mal alle lateinischen Begriffe konsistent groß oder kleinschreiben, momentan ist das total unterschiedlich. Ich traue mich das nicht selbst zu da ich kein Latein kann und nicht weiß, ob da ein Grund dahintersteckt.}
...
The ontology was created to be used in conjunction with the anthropological 3D editor \aw{}.
AW3D allows users to examine digitized bone material which can be created using a pipeline that was designed specifically for creating 3D models of bones for use in anthropological morphological and osteometric research and examination.
To allow such an examination the software can import and render these 3D models at runtime and provides a wide suite of tools for the annotation and measuring of bone material.
The ontology was integrated into the software to better meet the use cases of AW3D.
...
These use cases are already covered by AW3D itself but are improved by an integration of ANNO into the software.
