...
\caption{The \emph{Corpus ossis pubis} (pubic body, see \cref{fig:corpusossispubis}) forms the proximal part of the \emph{Os pubis} and includes the anterior part of the \emph{Acetabulum} as well as the \emph{Eminentia iliopubica}, which is a small elevation on the \emph{Corpus ossis pubis}.
...
it is logical to place the \emph{Corpus ossis pubis} in this region as well~\citep{graysanatomy,waldeyer,allgemeineanatomie,datacollection,romanianmandible}, thereby forming the \emph{Acetabulum} from all Corpi (\emph{Corpus ossis ilii}, \emph{Corpus ossis ischii}, and \emph{Corpus ossis pubis}).
...
This redefinition closes the resulting gap in the definition of the area between the \emph{Ramus inferior ossis pubis} and the \emph{Ramus superior ossis pubis}.
